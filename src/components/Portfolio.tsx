...
const portfolioItems = [
  {
    ...
    description: "Designed and developed a fast, minimal, and professional website for NexAgency.",
    tags: ["Next.js", "React", "Node.js", "Tailwind CSS"],
    liveUrl: "https://nexagency.netlify.app",
    githubUrl: "https://github.com/Anubhav2qrz/Next-Agency-Mentors",
    status: "Live",
  ...
  },
  {
    ...
    description: "A user-friendly fitness app designed to track workouts, set goals, and visualize performance.",
    tags: ["Next.js", "React", "Node.js", "Tailwind CSS"],
    liveUrl: "https://fitsyncpro.netlify.app",
    githubUrl: "https://github.com/Anubhav2qrz/Fitness-Tracker-Pro",
    status: "Live",
    type: "Web Development",
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {portfolioItems.map((item, index) => (
            ...
            >
              ...
              {/* Action Buttons with LIVE LINKS */}
              <div className="flex gap-3">
                ...
                >
                  <Button
                    variant="ghost"
                    size="sm"
                    className="w-full border border-border/30 hover:border-primary/30 hover:bg-primary/5 hover:text-primary transition-all duration-300"
                  >
